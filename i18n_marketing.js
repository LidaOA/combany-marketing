const mkt_translations = {
    fr: {
        ...
        hero_title: "Gagne des <br /><span class=\"text-transparent bg-clip-text bg-gradient-to-r from-white to-[#1565d8]\">entretiens.</span>",
        hero_desc: "Prouve un <span class=\"text-white font-bold\">match culturel</span> et un <span class=\"text-white font-bold\">intérêt fort</span> instantanément aux recruteurs en personnalisant ton CV avec le logo exact de leur entreprise. <b>En 1 clic.</b>",
        ...
        feature1_desc: "Extrais le logo de n'importe quelle offre d'emploi et appose-le sur ton PDF en un seul clic. Pas de manipulation complexe.",
        feature2_title: "Logos HD & Ajustables",
        feature2_desc: "Profite d'une qualité d'image optimale. Le logo est automatiquement redimensionné et positionné pour un rendu professionnel.",
        feature3_title: "Multi-plateformes",
        feature3_desc: "Fonctionne sur LinkedIn et très bientôt sur de nombreuses autres plateformes de recrutement.",
        pricing_title: "Un investissement pour ta carrière.",
        pricing_desc: "Ne laisse pas ton CV se perdre dans la masse. Multiplie tes chances d'obtenir un entretien par 4 avec une personnalisation soignée.",
    ...
    en: {
        ...
        feature3_desc: "Works on LinkedIn and very soon on many other job offer platforms.",
